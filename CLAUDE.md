...
1. **Приведение к 3-страничной структуре** (раздел 3) — убрать страницу категорий, создание на лету. *(Этап 5)*
2. Редактирование транзакций (сейчас только удаление); фильтры по дате/сумме. *(Этап 6)*
3. *(позже)* Голосовой ввод в боте (audio → текст).
